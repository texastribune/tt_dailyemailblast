...
def send_daily_email_blasts(blast_pk):
    ...
    logger.debug('Sending blast for %s' % blast)
...
def send_recipients_list(recipients_list_pk, blast_pk):
    ...
    logger.debug('Sending blast for %s to %s' % (blast, recipients_list))
...
def send_recipient(recipient_pk, recipients_list_pk, blast_pk):
    ...
    logger.debug('Sending blast %s to %s of list %s' % (blast, recipient,
            recipients_list))
