...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DailyEmailBlast.subject'
        db.add_column('tt_dailyemailblast_dailyemailblast', 'subject',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DailyEmailBlast.subject'
        db.delete_column('tt_dailyemailblast_dailyemailblast', 'subject')
